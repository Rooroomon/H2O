...
MAP3 = [
    ...
    "S#↑..........←←←←←←←←←←....poooo00....↓GC#",
    "X#↑..........0000000000....←←←←←00....↓CC#",
    "X#↑..........___0000000]..._______....↓CC#",
    "X#↑..........poo0000000....poooooq....┘CC#",
    "←←←←←←←←←←←←←←←←0000000←←←←←←←←←←←←←←←←←←#",
]              
Special3 = [              
    "..........................................",
...
MAP4 = [
    ...
    "X#↑..........................000000XXX",
    "←←←←←←←←←←←←←←←←←←←←←←←..←←←←000000XXX",
    "XXXXXXXXXXXXXXXXXXXXXX0..0XXXXXXXXXXXX",
    "XXXXXXXXXXXXXXXXXXXXXX0..0XXXXXXXXXXXX",
    "XXXXXXXXXXXXXXXXXXXXXX0000XXXXXXXXXXXX",
]
Special4 = [
    ".......................................",
    ".......................................",
...
Special_List = [Special1, Special2, Special3, Special4, Special5]
...
TILE_INFO = {
    ...
    "_": {"index": 4, "solid": "Wall"},
    "p": {"index": 10, "solid": "None"},
    "o": {"index": 11, "solid": "None"},
    "q": {"index": 16, "solid": "None"},
...
def get_slopePair(map, target, y, x):
    # 현재 위치 이후부터 탐색
    for yy in range(y, len(map)):
        start_x = x + 1 if yy == y else 0
        
        for xx in range(start_x, len(map[yy])):
            if map[yy][xx] == target:
        ...
        for y, row in enumerate(self.map_data):
            for x, ch in enumerate(row):
                if ch.isdigit() and ch != "0" and found & (0b1<<int(ch)) == 0:   # 1~9 발견
                    ...
                    found |= (0b1<<int(ch))
                    result = get_slopePair(self.map_data, ch, y, x)
        ...
        for y, row in enumerate(self.special_data):
            for x, tile in enumerate(row):
                if tile == "B":
                    ...
                    object = Ball(x * TILE_SIZE, y * TILE_SIZE, self.balls)
        ...
        while(first != second):
            for dir in [pygame.math.Vector2(0, 1), pygame.math.Vector2(1, 0), pygame.math.Vector2(0, -1), pygame.math.Vector2(-1, 0)]:
                ...
                if tile in ["┌", "┐", "└", "┘", "─", "│"]: #이어진 전선 찾음
                    ...
                    power.target = Electro_Object(finding_pos.x * TILE_SIZE, finding_pos.y * TILE_SIZE, "door")
                    return
                elif tile == "d":
                    power.target = Electro_Object(finding_pos.x * TILE_SIZE, finding_pos.y * TILE_SIZE, "doorR")
                    return
                elif tile == "G":
                    power.target = Electro_Object(finding_pos.x * TILE_SIZE, finding_pos.y * TILE_SIZE, "generator")
                    return
            second = first.copy()
